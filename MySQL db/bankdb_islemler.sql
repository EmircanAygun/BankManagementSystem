...
CREATE TABLE `islemler` (
  ...
  `IslemAdi` varchar(45) NOT NULL,
  PRIMARY KEY (`IslemNo`,`IslemAdi`)
...
INSERT INTO `islemler` VALUES (1,'Para Çekme'),(2,'Para Yatırma'),(3,'Havale'),(4,'Bakiye Sorgulama'),(5,'Şifre Değiştirme');
